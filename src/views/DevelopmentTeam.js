            ...
            <div className="DevTeam">
                <div>
                    <div className="Dev-banner">
                        <img className="Dev-crop" src="https://image.freepik.com/foto-gratis/imagen-primer-plano-programador-trabajando-su-escritorio-oficina_1098-18707.jpg"   alt="banner-dev"></img>
